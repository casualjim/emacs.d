...

;;;### (autoloads (string-utils-split string-utils-squeeze-url string-utils-squeeze-filename
;;;;;;  string-utils-plural-ending string-utils-propertize-fillin
;;;;;;  string-utils-pad-list string-utils-pad string-utils-quotemeta
;;;;;;  string-utils-escape-double-quotes string-utils-string-repeat
;;;;;;  string-utils-compress-whitespace string-utils-trim-whitespace
;;;;;;  string-utils-has-whitespace-p string-utils-has-darkspace-p
;;;;;;  string-utils-stringify-anything) "string-utils" "string-utils.el"
;;;;;;  (20646 45245))
...
;;;***

;;;### (autoloads nil nil ("string-utils-pkg.el") (20646 45245 667858))
